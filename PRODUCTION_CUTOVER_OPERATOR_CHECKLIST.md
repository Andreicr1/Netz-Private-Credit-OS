# Production Cutover Operator Checklist (Condensed, Transcript-Identical)
...
- [ ] `python -m alembic heads` captured to `..\tmp\prod_heads_preflight.log`
- [ ] `python -m alembic history --verbose` captured to `..\tmp\prod_history_preflight.log`
- [ ] `python ..\tmp\forensic_0019_structural_validation.py` captured to `..\tmp\prod_anchor_structural_parity_0019.log`
- [ ] `python ..\tmp\forensic_monthly_report_packs_fks.py` captured to `..\tmp\prod_monthly_report_packs_fks.log`
...
- [ ] `python ..\tmp\clone_alembic_width_precheck.py` captured to `..\tmp\prod_alembic_width_precheck.log`
- [ ] `python ..\tmp\clone_alembic_width_correction.py` captured to `..\tmp\prod_alembic_width_correction.log`
...
- [ ] `python -m alembic stamp 0019_nav_snapshots_and_investor_statements` captured to `..\tmp\prod_stamp_anchor.log`
- [ ] `python -m alembic current` captured to `..\tmp\prod_current_post_stamp.log`
...
- [ ] `python -m alembic upgrade head` captured to `..\tmp\prod_upgrade_0019_to_head.log`
...
- [ ] `python -m alembic current` captured to `..\tmp\prod_post_upgrade_current.log`
- [ ] `python -m alembic heads` captured to `..\tmp\prod_post_upgrade_heads.log`
- [ ] `python ..\tmp\clone_ai4_object_parity_rerun.py` captured to `..\tmp\prod_ai4_object_parity.log`
