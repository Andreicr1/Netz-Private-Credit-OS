...
from app.core.security.dependencies import get_actor, require_fund_access
from app.core.security.rbac import require_role
from app.domain.portfolio.models.assets import PortfolioAsset
from app.domain.portfolio.schemas.assets import PortfolioAssetCreate, PortfolioAssetOut
...
@router.post("", response_model=PortfolioAssetOut, status_code=status.HTTP_200_OK)
def create_asset(
    fund_id: uuid.UUID,
