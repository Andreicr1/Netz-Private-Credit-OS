...
def _document_corpus(db: Session, doc: DocumentRegistry) -> str:
    chunks = []
...
def link_document(
    ...
    *,
    ...
    corpus = _document_corpus(db, doc)
...
def map_obligation_evidence(
    ...
    *,
    ...
    evidence_corpus = {row.id: _document_corpus(db, row) for row in evidence_docs}
